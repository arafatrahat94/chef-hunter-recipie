...
const Register = () => {
  ...
  return (
    <div>
      <div className="grid mt-6 lg:mt-0 min-h-[71vh] lg:grid-cols-2 relative">
        ...
        <div className="relative mb-2 rounded-lg lg:mx-0 mx-2 flex flex-col items-center justify-center">
          ...
          >
            <button className="btn bg-white text-pink-700 rounded-lg border-pink-600 border-2 btn-primary">
