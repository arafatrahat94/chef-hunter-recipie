...
const Home = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute py-2 lg:ps-4 backdrop-blur lg:p-3 lg:pb-4 border-base-300 shadow-md text-center shadow-black rounded-e-3xl left-0 z-10 customO:top-[165px] top-[150px] lg:top-[330px] lg:py-4 w-10/12 lg:pe-4">
      ...
      <div className="my-8 relative ">
        ...
        <div className="ms-2 lg:ms-12 lg:w-[650px] lg:text-justify absolute top-[18px] lg:top-[125px]">
          <h1 className="text-xl lg:text-4xl text-white font-Nunito font-semibold">
            We Have Over{" "}
            <span className="text-pink-400 text-2xl lg:text-4xl font-DancingS font-bold">
              20000+
            </span>{" "}
            Customer in Whole{" "}
            <span className="text-pink-500  lg:text-4xl  text-2xl ">State</span>{" "}
            and{" "}
            <span className="text-pink-400 font-DancingS font-bold  text-2xl lg:text-4xl ">
              20
            </span>{" "}
            outlets in whole{" "}
            <span className="text-pink-400  text-2xl lg:text-4xl  font-DancingS font-bold">
