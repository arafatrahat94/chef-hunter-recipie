...
const Home = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute py-2 lg:ps-4 backdrop-blur lg:p-3 lg:pb-4 border-base-300 shadow-md text-center shadow-black rounded-e-3xl left-0 z-10 customO:top-[165px] top-[150px] lg:top-[330px] lg:py-4 w-[75%] lg:pe-4">
